...
import { LogoutOutlined,ReconciliationOutlined, EditOutlined, QuestionCircleOutlined } from '@ant-design/icons';
    ...
    return (
        <ConfigProvider
            ...
            <header className='col-span-2 flex justify-end-safe bg-[#3A3C40] gap-15 p-5 items-center max-md:gap-8'>
                <Image src="/feedback.svg" alt="feedback" width={32} height={32} className=' aspect-square max-md:w-5' />
                <Image src="/alert.svg" alt="alert" width={32} height={32} className=' aspect-square max-md:w-5' />

                <Dropdown menu={{ items }} trigger={['click']}>
                    <Link href="#" onClick={(e) => e.preventDefault()}>
                        <Space>
                            <Image src="/avatar.svg" alt="profile" height={48} width={48} className='aspect-square max-md:w-8' />
                        </Space>
                    </Link>
                </Dropdown>
            </header>   
