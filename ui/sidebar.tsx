...
export function BotIcon() {
  return (
    <div className="bg-[#a7a0f8] rounded-[15px] flex justify-center items-center h-12 w-12">
  ...
  return (
    ...
    >
      <Button
        ...
        className="rounded-[15px] flex justify-center items-center h-12 w-12 hover:selection:"
      ...
      <div
        className={`flex flex-col bg-[#3a3c40] transition-all duration-200 ease-int-out h-full ${
